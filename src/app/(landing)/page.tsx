			...
			>
				<div className="container flex h-16 items-center justify-between">
					...
					<div className="flex items-center gap-2">
						...
						<Link
							href="/auth/login"
							className="text-sm font-medium transition-colors hover:text-primary md:block hidden"
						>
							Sign In
						</Link>
							...
							>
								...
								<div className="space-y-2">
									...
									<p className="max-w-[600px] text-muted-foreground md:text-xl">
										Real-time monitoring, analytics, and automation for your
										warehouse operations. Increase efficiency, reduce costs, and
				...
				>
					<div className="container px-4 md:px-6">
						...
						>
							...
							<div className="space-y-2">
								<h2 className="text-3xl font-bold tracking-tighter md:text-4xl">
									Complete Warehouse Intelligence
								</h2>
								<p className="max-w-[900px] text-muted-foreground md:text-xl">
									Our platform provides all the tools you need to monitor,
									analyze, and optimize your warehouse operations.
								</p>
							</div>
						</motion.div>
						...
						>
							...
							<TabsContent
								value="monitoring"
								className="mt-8 tab-content-animate"
							>
								<div className="grid md:grid-cols-2 gap-8 items-center">
									...
									>
										...
										<p className="text-muted-foreground">
											Track inventory levels, equipment status, and
											environmental conditions in real-time with our advanced
											sensor network. Get instant alerts when metrics fall
							...
							>
								<div className="grid md:grid-cols-2 gap-8 items-center">
									...
									>
										...
										<p className="text-muted-foreground">
											Automate routine tasks, optimize picking routes, and
											streamline operations with AI-powered workflows. Reduce
											manual errors and increase throughput.
										</p>
										<ul className="space-y-2">
											<li className="flex items-center gap-2">
												<div className="h-5 w-5 rounded-full bg-primary/20 flex items-center justify-center">
							...
							>
								<div className="grid md:grid-cols-2 gap-8 items-center">
									...
									>
										...
										<p className="text-muted-foreground">
											Protect your assets with comprehensive security
											monitoring, access control, and incident detection. Ensure
							...
							>
								<div className="grid md:grid-cols-2 gap-8 items-center">
									...
									>
										...
										<p className="text-muted-foreground">
											Gain actionable insights with customizable dashboards,
											predictive analytics, and comprehensive reporting. Make
					...
					<div className="container px-4 md:px-6 relative">
						...
						>
							...
							<div className="space-y-2">
								...
								<p className="max-w-[900px] text-muted-foreground md:text-xl">
									Get up and running quickly with our easy-to-implement
						...
						>
							...
							>
								...
								<p className="text-muted-foreground">
									Our plug-and-play sensors can be installed in your warehouse
									in minutes, with no complex wiring or configuration required.
								</p>
							</motion.div>
							...
							>
								...
								<p className="text-muted-foreground">
									Connect to our cloud platform and customize your dashboard to
							...
							>
								...
								<p className="text-muted-foreground">
									Use real-time data and actionable insights to optimize your
							...
							>
								<Card className="h-full border-primary/10 hover:border-primary/30 transition-colors">
									<CardHeader>
										<div className="flex items-center gap-4">
											...
											<div>
												...
												<CardDescription>
													Operations Director, Global Shipping Co.
												</CardDescription>
											</div>
										</div>
									</CardHeader>
									<CardContent>
										...
										<p className="text-muted-foreground">
											"WarehouseIQ has completely transformed our warehouse
											operations. We've reduced picking errors by 45% and
											improved inventory accuracy to 99.8%. The real-time
							...
							>
								<Card className="h-full border-primary/10 hover:border-primary/30 transition-colors">
									...
									<CardContent>
										...
										<p className="text-muted-foreground">
											"The security features in WarehouseIQ are unmatched. As a
											fast-growing e-commerce company, we needed a solution that
											could scale with us while keeping our inventory secure.
											WarehouseIQ delivered."
										</p>
									</CardContent>
								</Card>
							</motion.div>
							...
							>
								<Card className="h-full border-primary/10 hover:border-primary/30 transition-colors">
									<CardHeader>
										<div className="flex items-center gap-4">
											...
											<div>
												...
												<CardDescription>
													Supply Chain Manager, Retail Giant
												</CardDescription>
											</div>
										</div>
									</CardHeader>
									<CardContent>
										...
										<p className="text-muted-foreground">
											"The analytics capabilities have given us insights we
											never had before. We've optimized our inventory levels,
											reduced carrying costs by 22%, and improved order
											fulfillment times dramatically."
										</p>
									</CardContent>
								</Card>
							</motion.div>
					...
					<div className="container grid items-center gap-6 px-4 md:px-6 lg:grid-cols-2 lg:gap-10 relative">
						...
						>
							...
							<p className="max-w-[600px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
								Join industry leaders who have optimized their supply chain with
								WarehouseIQ's intelligent monitoring solutions.
							</p>
						</motion.div>
						<motion.div
							initial="hidden"
			...
			<footer className="w-full border-t py-12 md:py-16 lg:py-20">
				<div className="container grid gap-8 px-4 md:px-6 lg:grid-cols-4">
					<div className="space-y-4">
						...
						<p className="text-sm text-muted-foreground">
							Intelligent warehouse monitoring and optimization solutions for
				...
				<div className="container flex flex-col gap-4 sm:flex-row py-6 items-center px-4 md:px-6 border-t mt-10">
					<p className="text-xs text-muted-foreground">
						&copy; {new Date().getFullYear()} WarehouseIQ, Inc. All rights
						reserved.
					</p>
