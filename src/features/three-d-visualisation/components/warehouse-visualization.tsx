    ...
    <div className="container mx-auto p-4 h-full flex flex-col">
      ...
      <Link href={"/dashboard"} className="h-fit">
        ...
        <div className="flex items-center gap-4">
          <Select value={focusedRobotId || "all"} onValueChange={handleRobotSelect}>
          ...
          <Tabs value={selectedView} onValueChange={(v) => setSelectedView(v as "3d" | "2d")}>
            <TabsList>
...
function RobotStatusCard({
  ...
  return (
    <Card
      className={`cursor-pointer transition-all w-full ${isFocused ? "ring-2 ring-primary" : ""}`}
      onClick={onFocus}
    >
      <div className="p-4">
